<?php
/**
 * 11:11 Decor — Gutenberg 3-Column Studio: Edit Post & Live Rank Math SEO
 */
session_start();
...
<head>
    ...
    <title>Gutenberg Studio — Edit Post — 11:11 Decor</title>
...
<body>
    <form method="POST" action="" enctype="multipart/form-data" id="post-form">
        ...
        <input type="hidden" id="focus-keyword-input" name="focus_keyword" value="<?= htmlspecialchars($post['focus_keyword'] ?? '') ?>">
        ...
        <div class="studio-3col-grid">
            ...
            <aside class="studio-sidebar studio-sidebar-left">
                ...
                <div class="publish-card">
                    <label class="checkbox-label" style="margin-bottom: 0.75rem;">
                        <input type="checkbox" name="published" value="1" <?= $post['published'] ? 'checked' : '' ?> style="width: 16px; height: 16px;">
                        <span>Publish live immediately</span>
                    </label>
                    <button type="submit" class="btn-publish-top" style="width: 100%;">Save Changes &rarr;</button>
                </div>

                <div class="sidebar-group">
                    <div class="sidebar-group-title">URL Slug *</div>
                    <input type="text" id="slug" name="slug" required value="<?= htmlspecialchars($post['slug']) ?>" class="sidebar-input">
                ...
                <div class="sidebar-group">
                    ...
                    <input type="text" id="author" name="author" value="<?= htmlspecialchars($post['author']) ?>" class="sidebar-input">
                </div>

                <div class="sidebar-group">
                    <div class="sidebar-group-title">Estimated Read Time</div>
                    <input type="text" id="read_time" name="read_time" value="<?= htmlspecialchars($post['read_time']) ?>" class="sidebar-input">
                </div>
                ...
                <div class="sidebar-group" style="background: #202020; padding: 1rem; border-radius: 8px; border: 1px solid #303030;">
                    ...
                    <input type="text" id="image_url" name="image_url" value="<?= htmlspecialchars($post['image']) ?>" class="sidebar-input" style="margin-bottom: 0.8rem;">

                    <div id="featured-image-preview-wrapper" style="margin-bottom: 0.8rem; display: <?= !empty($post['image']) ? 'block' : 'none' ?>;">
                        <div style="position: relative; border-radius: 6px; overflow: hidden; border: 1px solid #444; max-height: 160px; background: #111; display: flex; align-items: center; justify-content: center;">
                            <img id="featured-image-preview" src="<?= htmlspecialchars($post['image'] ?? '') ?>" alt="Featured preview" style="width: 100%; height: auto; max-height: 160px; object-fit: cover; display: block;">
                ...
                <div class="sidebar-group">
                    ...
                    <input type="text" id="related_service_slug" name="related_service_slug" value="<?= htmlspecialchars($post['related_service_slug'] ?? '') ?>" class="sidebar-input" style="margin-bottom: 0.25rem;">
                    ...
                    <input type="text" id="related_service_name" name="related_service_name" value="<?= htmlspecialchars($post['related_service_name'] ?? '') ?>" class="sidebar-input" style="margin-bottom: 0.25rem;">
            ...
            <main class="gutenberg-canvas">
                ...
                ><?= htmlspecialchars($post['title']) ?></textarea>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            if (titleEl) autoExpandTextarea(titleEl);
            if (excerptEl) autoExpandTextarea(excerptEl);
        });
