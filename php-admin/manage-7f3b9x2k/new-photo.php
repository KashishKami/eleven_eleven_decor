<?php
/**
 * 11:11 Decor — Add New Gallery Photo
 */
session_start();
...
<head>
    ...
    <title>New Photo — 11:11 Decor</title>
    ...
    <div class="container">
        <header>
            <div>
                ...
                <p style="color: #8a8275; font-size: 0.85rem;">Upload New Gallery Photo</p>
            </div>
            <div>
        ...
        <form method="POST" class="form-card">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" placeholder="e.g. Royal Mandap Orchid Canopy" required>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="category" name="category">
                        ...
                        <option value="Venue Designs">Venue Designs</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="aspectRatio" name="aspectRatio">
                        ...
                        <option value="portrait">Portrait (Vertical / Tall)</option>
            ...
            <div class="form-group">
                ...
                <div class="dropzone-box" onclick="document.getElementById('photo-file-input').click()">
                    <p style="color: #a39c90; font-size: 0.9rem;">📁 Drag &amp; drop your image here or click to browse</p>
                    ...
                    <img id="photo-preview" class="dropzone-preview" alt="Preview">
                </div>
            ...
            <div style="margin-top: 2rem; display: flex; justify-content: flex-end;">
                ...
                <button type="submit" class="btn-primary">Save &amp; Publish Photo</button>
            </div>
        </form>
    </div>
