<?php
/**
 * 11:11 Decor — Create New Portfolio Project with Live Slug & Image Upload
 */
session_start();
...
<head>
    ...
    <title>New Project — 11:11 Decor</title>
...
<body>
    <div class="container">
        <header>
            <div>
                ...
                <p style="color: #8a8275; font-size: 0.85rem;">Create New Portfolio Project</p>
            </div>
            <div>
        ...
        <form method="POST" class="form-card">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" placeholder="e.g. Royal Palace Wedding in Dehradun" oninput="autoGenerateSlug(this.value)" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="slug-input-wrapper">
                    ...
                    <input type="text" id="slug" name="slug" placeholder="royal-palace-wedding-dehradun" required>
                    <span class="slug-prefix">/</span>
                </div>
                <p class="help-text">Live link: <code>https://elevenelevendecor.com/portfolio/<span id="slug-preview">royal-palace-wedding-dehradun</span>/</code></p>
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label for="subtitle">Subtitle / Tagline</label>
                    <input type="text" id="subtitle" name="subtitle" placeholder="e.g. A Multi-Day Palace Celebration">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="venue" name="venue" placeholder="e.g. JW Marriott Walnut Grove">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="guestCount" name="guestCount" placeholder="400">
                </div>
                
                <!-- Hero Image Upload with Direct File Picker & Dropzone -->
                <div class="form-group">
                    <label>Hero Cover Photo *</label>
                    <div class="dropzone-box" id="hero-dropzone" onclick="document.getElementById('hero-file-input').click()">
            ...
            <div class="form-group">
                ...
                <textarea id="summary" name="summary" rows="3" placeholder="Brief 2-3 sentence overview of the project and creative concept."></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="help-text">Upload photos above or paste one full image URL per line.</p>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <textarea id="planningDetails" name="planningDetails" rows="3" placeholder="Curated custom 3D mandap rendering&#10;Coordinated 12 vendor teams"></textarea>
                </div>
                <div class="form-group">
                    <label for="decorHighlights">Decor Highlights (One per line)</label>
                    <textarea id="decorHighlights" name="decorHighlights" rows="3" placeholder="Imported Dutch hydrangeas and white orchids&#10;Bespoke chandelier canopy"></textarea>
                </div>
            </div>

            <div class="form-group">
                <label for="executionNotes">Execution &amp; Production Notes</label>
                <textarea id="executionNotes" name="executionNotes" rows="3" placeholder="Backstage logistical details, setup window, and unique staging highlights."></textarea>
            </div>
            ...
            <div style="margin-top: 2rem; display: flex; justify-content: flex-end;">
                ...
                <button type="submit" class="btn-primary">Save &amp; Publish Project</button>
            </div>
        </form>
    </div>
    ...
    function autoGenerateSlug(title) {
        ...
        document.getElementById('slug-preview').textContent = slug || 'project-slug';
    }
