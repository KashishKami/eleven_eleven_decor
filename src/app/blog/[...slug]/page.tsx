...
export default function DynamicBlogRoute({ params }: { params: { slug: string[] } }) {
      ...
      >
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '4rem 1rem' }}>
            <p style={{ fontSize: '1.25rem', color: '#6b6b6b' }}>No articles published in this category yet.</p>
            <Link
              href="/blog"
              style={{
                display: 'inline-block',
  ...
  if (loading) {
    return (
      <div style={{ paddingTop: '140px', minHeight: '80vh', textAlign: 'center', backgroundColor: '#faf6f0' }}>
        <p style={{ color: '#8a8275', fontSize: '1.25rem' }}>Loading article...</p>
      </div>
    )
  }
  ...
  if (error || !post) {
    return (
      <div style={{ paddingTop: '140px', minHeight: '80vh', textAlign: 'center', backgroundColor: '#faf6f0' }}>
        ...
        <p style={{ color: '#6b6b6b', marginBottom: '2rem' }}>The article you are looking for might have been moved or updated.</p>
        <Link
          href="/blog"
          style={{
            display: 'inline-block',
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ color: '#c9a96e', fontSize: '1.25rem' }}>{isOpen ? '−' : '+'}</span>
                    </button>
                    {isOpen && (
                      <div
                        style={{
        ...
        {post.relatedServiceSlug && (
          ...
          >
            <div>
              ...
              <h4 style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem', margin: 0 }}>
