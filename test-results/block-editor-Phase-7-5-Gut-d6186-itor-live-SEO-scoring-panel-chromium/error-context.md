...
=========================== logs ===========================
waiting for navigation to "**/dashboard.php" until "load"
============================================================
```
...
```yaml
- generic [ref=f1e2]:
  - generic [ref=f1e3]: 11:11 DECOR
  - generic [ref=f1e4]: Editorial Blog Studio
  - generic [ref=f1e5]: Invalid password. Please verify your credentials.
  - generic [ref=f1e6]:
    - generic [ref=f1e7]:
      - generic [ref=f1e8]: Admin Security Key
      - textbox "Admin Security Key" [active] [ref=f1e9]:
        - /placeholder: Enter your admin password
    - button "Enter Studio →" [ref=f1e10] [cursor=pointer]
```
