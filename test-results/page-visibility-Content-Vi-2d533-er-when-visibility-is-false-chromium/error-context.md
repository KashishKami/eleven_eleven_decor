...
Locator:  locator('header a[href*="/gallery"], nav a[href*="/gallery"], footer a[href*="/gallery"]')
Expected: 0
Received: 2
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('header a[href*="/gallery"], nav a[href*="/gallery"], footer a[href*="/gallery"]')
